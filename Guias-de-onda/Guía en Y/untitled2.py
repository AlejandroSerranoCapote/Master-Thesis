...
L = 500  # Longitud de la caja (micras)
...
zmax = 8000  # Distancia total de propagación (micras)
...
for zi, zi_val in enumerate(z):
    for xi, xi_val in enumerate(x):
        if zi_val < 2000:
            ...
            # Sección final con tres canales
            centers = [-60, 0, 60]  # Posiciones de los tres canales
