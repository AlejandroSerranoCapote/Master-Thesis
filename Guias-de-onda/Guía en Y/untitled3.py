# -*- coding: utf-8 -*-
"""
Simulación de propagación de ondas en una guía óptica con tres canales al final.
...
# =============================================================================
# Definir perfil de índice de refracción para la guía de onda con tres canales
# =============================================================================
...
def curve(z_val):
    return 50 * np.tanh((z_val - 2000) / zmax * 5)  # Suaviza la bifurcación
...
for zi, zi_val in enumerate(z):
    for xi, xi_val in enumerate(x):
        if zi_val < 2000:
            ...
            # Sección final con tres canales centrados con la curvatura
            width_final = curve(zmax)  # Ancho total determinado por la curvatura
            centers = np.linspace(-width_final, width_final, 3)  # Tres canales equidistantes
            for center in centers:
                for i in range(1, num_tracks + 1):
                    if abs(xi_val - (center + W / 2 + i * track_sep)) < track_width / 2 or \
                       abs(xi_val - (center - W / 2 - i * track_sep)) < track_width / 2:
                        n_profile[zi, xi] = n1
...
# =============================================================================
# Algoritmo FFT-BPM para la propagación de la onda
# =============================================================================
